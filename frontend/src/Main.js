      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-3 gap-20 lg:grid-cols-3">
          <div className="mb-10">
            ...
            <br />
            Xpert는 매장 키오스크 사용법부터 교통앱, 모바일 뱅킹 앱, 유틸리티 서비스와 같은 다양한 디지털 서비스 사용법을 
            쉽고 친절하게 안내합니다.
            </p>
        </div>
        <div className="mx-12">
        ...
        <div className="Phone h-6 relative">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 23.5"width="17" height="17"style={{ transform: "translateY(10px)" }}>
             <path d="M24.537 17.0082L19.0682 14.8015C18.8346 14.7078 18.5749 14.688 18.3283 14.7452C18.0818 14.8024 17.8616 14.9335 17.701 15.1187L15.2791 17.9047C11.4781 16.2174 8.41919 13.3374 6.62706 9.75868L9.5861 7.47841C9.78321 7.32747 9.92272 7.12017 9.98352 6.8879C10.0443 6.65564 10.0231 6.41104 9.92302 6.19115L7.57923 1.04214C7.46942 0.80511 7.2752 0.611579 7.03007 0.494923C6.78494 0.378267 6.50426 0.345798 6.23643 0.403115L1.15822 1.50647C0.899996 1.56262 0.669609 1.69951 0.50466 1.8948C0.339711 2.0901 0.249941 2.33227 0.25 2.58179C0.25 14.3739 10.4015 23.9134 22.9066 23.9134C23.1717 23.9136 23.4291 23.8291 23.6366 23.6738C23.8441 23.5185 23.9896 23.3015 24.0492 23.0583L25.2211 18.2771C25.2816 18.0237 25.2464 17.7584 25.1215 17.5268C24.9967 17.2952 24.79 17.1118 24.537 17.0082Z" fill="white"/>
          </svg>
        <div className="phonenum left-[30px] top-0 mt-2 absolute text-white font-light">02-1234-1234</div>
        </div>
        <div className="Phone h-6 relative">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 32" width="20" height="16" style={{ transform: "translateY(20px)" }}>
            <path d="M35.5938 0.913452H3.90625C1.88693 0.913452 0.25 2.64832 0.25 4.78845V28.0385C0.25 30.1786 1.88693 31.9135 3.90625 31.9135H35.5938C37.6131 31.9135 39.25 30.1786 39.25 28.0385V4.78845C39.25 2.64832 37.6131 0.913452 35.5938 0.913452ZM35.5938 4.78845V8.0826C33.8858 9.55664 31.163 11.8487 25.342 16.6795C24.0592 17.7489 21.5181 20.3181 19.75 20.2881C17.9822 20.3184 15.4403 17.7485 14.158 16.6795C8.33793 11.8494 5.6144 9.55688 3.90625 8.0826V4.78845H35.5938ZM3.90625 28.0385V13.055C5.65165 14.5283 8.12686 16.5959 11.8996 19.7269C13.5645 21.1158 16.4801 24.182 19.75 24.1634C23.0038 24.182 25.8825 21.1603 27.5997 19.7275C31.3724 16.5966 33.8483 14.5285 35.5938 13.055V28.0385H3.90625Z" fill="white"/>
          </svg>
        <div className="phonenum left-[30px] top-0 mt-4 absolute text-white font-light">xpert@gmail.com</div>
        </div>
        <ul className="icon-list" style={{ display: 'flex' }}>
          <li>
            <a href="https://www.instagram.com/" >
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="56" viewBox="0 0 58 56" style={{ transform: "translate(-5px,25px)" }}>
            <ellipse cx="28.75" cy="27.7047" rx="28.5" ry="27.5" fill="#A7A7A7" fill-opacity="0.3"/>
            <path d="M28.7541 17.9748C23.5044 17.9748 19.2699 22.0957 19.2699 27.2047C19.2699 32.3137 23.5044 36.4347 28.7541 36.4347C34.0039 36.4347 38.2383 32.3137 38.2383 27.2047C38.2383 22.0957 34.0039 17.9748 28.7541 17.9748ZM28.7541 33.2054C25.3616 33.2054 22.5881 30.5143 22.5881 27.2047C22.5881 23.8951 25.3533 21.204 28.7541 21.204C32.1549 21.204 34.9201 23.8951 34.9201 27.2047C34.9201 30.5143 32.1467 33.2054 28.7541 33.2054ZM40.8385 17.5972C40.8385 18.7941 39.8479 19.7501 38.6263 19.7501C37.3964 19.7501 36.4141 18.7861 36.4141 17.5972C36.4141 16.4083 37.4047 15.4444 38.6263 15.4444C39.8479 15.4444 40.8385 16.4083 40.8385 17.5972ZM47.12 19.7822C46.9797 16.8983 46.3028 14.3438 44.1319 12.2392C41.9693 10.1345 39.3444 9.47583 36.3811 9.33123C33.327 9.16254 24.173 9.16254 21.1189 9.33123C18.1638 9.46779 15.539 10.1265 13.3681 12.2312C11.1972 14.3358 10.5286 16.8903 10.38 19.7742C10.2067 22.7464 10.2067 31.655 10.38 34.6272C10.5203 37.5111 11.1972 40.0656 13.3681 42.1702C15.539 44.2749 18.1556 44.9336 21.1189 45.0782C24.173 45.2469 33.327 45.2469 36.3811 45.0782C39.3444 44.9416 41.9693 44.2829 44.1319 42.1702C46.2946 40.0656 46.9714 37.5111 47.12 34.6272C47.2933 31.655 47.2933 22.7544 47.12 19.7822ZM43.1744 37.8163C42.5306 39.3908 41.2842 40.6038 39.6581 41.2384C37.2231 42.1783 31.445 41.9614 28.7541 41.9614C26.0632 41.9614 20.2769 42.1702 17.8502 41.2384C16.2323 40.6118 14.9859 39.3988 14.3338 37.8163C13.3681 35.4466 13.5909 29.8235 13.5909 27.2047C13.5909 24.5859 13.3763 18.9548 14.3338 16.5931C14.9777 15.0186 16.2241 13.8056 17.8502 13.171C20.2852 12.2312 26.0632 12.448 28.7541 12.448C31.445 12.448 37.2313 12.2392 39.6581 13.171C41.2759 13.7976 42.5223 15.0106 43.1744 16.5931C44.1402 18.9628 43.9173 24.5859 43.9173 27.2047C43.9173 29.8235 44.1402 35.4546 43.1744 37.8163Z" fill="white"/>
            </svg>
            </a>
          </li>
          <li>
            <a href="https://www.youtube.com/" >
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="56" viewBox="0 0 58 56" style={{ transform: "translateY(25px)" }}>
              <ellipse cx="28.75" cy="27.7047" rx="28.5" ry="27.5" fill="#A7A7A7" fill-opacity="0.3"/>
              <path d="M48.3933 17.0552C47.9217 15.1459 46.5324 13.6423 44.7684 13.132C41.5711 12.2047 28.75 12.2047 28.75 12.2047C28.75 12.2047 15.929 12.2047 12.7316 13.132C10.9676 13.6423 9.57827 15.1459 9.10673 17.0552C8.25 20.5158 8.25 27.736 8.25 27.736C8.25 27.736 8.25 34.9563 9.10673 38.4169C9.57827 40.3262 10.9676 41.7672 12.7316 42.2775C15.929 43.2047 28.75 43.2047 28.75 43.2047C28.75 43.2047 41.571 43.2047 44.7684 42.2775C46.5324 41.7672 47.9217 40.3262 48.3933 38.4169C49.25 34.9563 49.25 27.736 49.25 27.736C49.25 27.736 49.25 20.5158 48.3933 17.0552ZM24.5568 34.2915V21.1806L35.2727 27.7362L24.5568 34.2915Z" fill="white"/>
            </svg>
            </a>
          </li>
          <li>
            <a href="https://www.youtube.com/" >
            <img src={blogImage} alt="blog" width="32" height="56" viewBox="0 0 58 56" style={{ transform: "translate(5px,35px)"}}/>
            </a>
          </li>
        </ul>
        </div>
